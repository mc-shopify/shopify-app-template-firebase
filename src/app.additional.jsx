export const meta = { title: 'Additional page', description: 'Additional page example' }
    ...
    <s-page heading="Additional page">
      <s-section heading="Multiple pages">
        ...
        <s-paragraph>
          ...
          a file like <code>app.mypage.jsx</code> in <code>src/</code>, then add
          a link to it in <code>app._layout.jsx</code>.
        </s-paragraph>
      </s-section>
